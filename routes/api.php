...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::apiResource('mahasiswa', MahasiswaController::class)->only(['index', 'show', 'destroy']);
        ...
        Route::put('tagihan/{id}', [PaymentController::class, 'updateTagihan'])->name('tagihan.update');
        Route::delete('tagihan/{id}', [PaymentController::class, 'destroyTagihan'])->name('tagihan.destroy');
