...
// Import semua controller dengan alias yang unik
...
use App\Http\Controllers\Kasir\PengaturanController as KasirPengaturanController; // <-- Tambahkan ini
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\CheckRole::class . ':kasir')->prefix('kasir')->name('kasir.')->group(function () {
        ...
        Route::get('/pengaturan', [KasirPengaturanController::class, 'index'])->name('pengaturan.index');
        Route::post('/pengaturan/update-password', [KasirPengaturanController::class, 'updatePassword'])->name('pengaturan.updatePassword');
    });
    ...
    Route::middleware(\App\Http\Middleware\CheckRole::class . ':mahasiswa')->prefix('mahasiswa')->name('mahasiswa.')->group(function () {
        ...
        Route::post('/profil/update-password', [MahasiswaProfilController::class, 'updatePassword'])->name('profil.updatePassword');
