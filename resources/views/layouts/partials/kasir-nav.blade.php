...
<nav class="mt-2 px-2 py-4">
    ...
    <a href="{{ route('kasir.tagihan') }}" aria-current="{{ request()->routeIs('kasir.tagihan*') ? 'page' : '' }}" class="flex items-center gap-3 px-4 py-3 mb-1 rounded-lg transition-all duration-200 {{ request()->routeIs('kasir.tagihan*') ? 'bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg shadow-primary-500/20' : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' }}">
    ...
    <a href="{{ route('kasir.aktivasi') }}" aria-current="{{ request()->routeIs('kasir.aktivasi*') ? 'page' : '' }}" class="flex items-center gap-3 px-4 py-3 mb-1 rounded-lg transition-all duration-200 {{ request()->routeIs('kasir.aktivasi*') ? 'bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg shadow-primary-500/20' : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' }}">
        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
        <span class="font-medium">Aktivasi Mahasiswa</span>
    </a>
